<template>
    <div class="page">
        <div class="body" v-if="state == 'true'">
            ...
            <div>
                <p class="text"><span>卡号:</span><span>{{ system.card.cardNumber }}</span></p>
                <p class="text"><span>圈存金额:</span><span>{{ amount }}元</span></p>
            </div>
            <span class="margin_1" style="">剩余{{ second }}s关闭页面......</span>
        </div>
        <div class="body" v-else>
            <img src="../../assets/images/coil-fail@2x.png" alt="" srcset="">
            <span class="margin_2" style="">圈存失败，请联系管理员处理，电话{{ adminPhone }}</span>
